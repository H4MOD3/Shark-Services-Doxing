...
username = input('\033[0;35m{+} Enter username to DOX: ')
...
Cyan = outer_func('[\033[0;36m')
Purple = outer_func('\033[0;35m')
RED = outer_func('\033[91m')
Blue = outer_func('\033[0;34m')
...
def banner():
   ...
   .d8888. db   db  .d8b.  d8888b. db   dD         
   88'  YP 88   88 d8' `8b 88  `8D 88 ,8P'        
   `8bo.   88ooo88 88ooo88 88oobY' 88,8P            
     `Y8b. 88~~~88 88~~~88 88`8b   88`8b   C8888D   
   db   8D 88   88 88   88 88 `88. 88 `88.        
   `8888Y' YP   YP YP   YP 88   YD YP   YD        
...
def search():
    Cyan(f'[+] Searching for username: {username}')
    time.sleep(0.5)
    print('.......')
    time.sleep(0.5)
    print('.......\n')
    ...
    Cyan(f'[+] The Shark eyes is Working')
    time.sleep(0.5)
    print('.......')
    time.sleep(0.5)
    print('.......\n')
